...
internal data class DetailedWeatherForecastList(var list: List<DetailedWeatherForecast> = listOf(
    ...
    fun getData(response: APIModel): MutableList<DetailedWeatherForecast> {
