...
var weathes: ArrayList<WeatherForecastForDay> = arrayListOf(
    WeatherForecastForDay(
        "16.04.2026", "thursday", 8,
        HourlyWeatherForecast(-2, 9, 6, -3)
    ),
    WeatherForecastForDay(
        "17.04.2026", "friday", 11,
        HourlyWeatherForecast(-1, 10, 7, -2)
    ),
    WeatherForecastForDay(
        "18.04.2026", "saturday", 7,
    ...
    WeatherForecastForDay(
        "20.04.2026", "monday", 12,
        HourlyWeatherForecast(0, 11, 10, 1)
    ),
    WeatherForecastForDay(
        "21.04.2026", "tuesday", 13,
        HourlyWeatherForecast(-2, 9, 6, -3)
    ),
    WeatherForecastForDay(
        "22.04.2026", "wednesday", 10,
        HourlyWeatherForecast(-2, 9, 6, -3)
    )
)
//рыркоевлвел
//TODO: строки длина не больше ширины экрана;
//TODO: растащить части кода по отдельным файлам;
//TODO:
@Composable
        ...
        for (weather in weathes) {
            Row(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .height(100.dp)
                    .background(Color(119, 13, 181), shape = RoundedCornerShape(25.dp))
                    .padding(5.dp)
                    .clickable(onClick = {
                        controller.navigate(
...
fun HourlyWeatherForecastScreen(
    ...
    //TODO: column заменить на lazyColumn;
    //TODO: убрать box;
    //TODO: привести в соответствие со скриншотами;
    //TODO: вынести строки в ресурсы;
    //TODO: 20-21 уроки по цветам;
    Column(
...
data class WeatherForecastForDay(
    val adata: String,
    val adayOfTheWeek: String,
    val atemperature: Int,
    val ahourlyWeather: HourlyWeatherForecast
)
//TODO: data  классы;

class HourlyWeatherForecast(
    atemperatureInTheMorning: Int,
    atemperatureInTheDay: Int,
    atemperatureInTheEvening: Int,
    atemperatureInTheNight: Int
) {
